...
tapi sebelum kita masuk membahas mengenai teknologinya
seperti biasa 

kita akan sedikit melihat konsep dan defini di dari mongoDB itu sendiri
kenapa kita membahas mengenai mongoDB ini?

kita sudah belajar mengenai node js, express 
nah dibeberapa latihan dimateri sebelumnya itu kita sudah

membuat sebuah aplikasi yaitu aplikasi sederhana 
yaitu pengelolaan data contact

tapi disitu kita menggunakan file json untuk mengelola 
data dari contactnya 

nah tentu saja kita ingin lebih flexible lagi 
untuk mengelola datanya menggunakan sebuah database

nah oleh karena itu diseri ini kita akan pilih mongoDB
sebagai database yang akan kita gunakan untuk 
melengkapi pembelajaran node  dan express kita 
...
kita akan ketelu lagi dimateri berikutnya 
